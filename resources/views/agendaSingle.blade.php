...
@section('content')
	...
	<nav class="flex" aria-label="Breadcrumb">
		<ol class="inline-flex items-center space-x-1 md:space-x-3 uppercase">
			...
			<a href="/" class="inline-flex items-center text-sm font-medium text-slate-300 hover:text-sky-500">
				Home
			</a>
			</li>
			<li>
				<div class="flex items-center">
					...
					<a href="{{ route('agenda') }}" class="ml-1 text-sm font-medium text-slate-700 hover:text-sky-500 md:ml- dark:text-gray-400">Agenda</a>
				</div>
			</li>
	...
	<div class="session__container mt-3">
		<div class="pt-6 space-y-3">
			<div class="font-devcon uppercase font-bold bg-gradient-to-r from-blue-600 to-indigo-400 inline-block text-transparent bg-clip-text mb-5 mt-3 text-center md:text-left text-3xl sm:text-5xl">
				{{ $s['title'] }}
			</div>
			<div class="speakers--wrapper max-w-4xl mx-auto block sm:flex">
				...
				<a class="speaker--headshot flex items-center mb-2 {{$classAddition}} flex justify-center" href="/speaker/{{ $speaker['id'] }}">
					...
					<div class="font-content text-sm sm:text-lg font-bold text-slate-800 ml-3">{{ $speaker['name'] }}</div>
				</a>
				@endforeach
			</div>

			<div class="location__datetime--wrapper block sm:flex font-md font-medium bg-sky-100 rounded-lg p-4 ">
			...
			<div class="font-dm text-lg font-regular leading-normal mt-4 pt-2 text-slate-400">
