        ...
        <div class="max-w-7xl mx-auto px-4 lg:px-4">
            <div class="flex flex-row justify-between py-2">
                ...
                <div class="hidden lg:flex flex-row gap-3 items-center fill-gray-50 hover:fill-gray-200">
                    ...
                    <a class="p-2 bg-[#E83F3B] transition duration-700 hover:bg-[#BF1F2E] hover:ease-in-out rounded-md uppercase text-sm font-bold font-button font-content text-gray-50" target="_blank" href="https://photos.app.goo.gl/7eP1bQubGdNDDkPf8">Photos</a>
                </div>
                <!-- Mobile Menu Button -->
